...
export default function ServicesEditor({ initialServices }: Props): React.JSX.Element {
  ...
  return (
    <div className="mt-8">
      ...
      <style>{`.input { width: 100%; border: 1px solid rgba(0,0,0,0.1); border-radius: 0.75rem; padding: 0.5rem 0.75rem; font-size: 0.875rem; outline: none; } .input:focus { border-color: #dc4080; box-shadow: 0 0 0 3px rgba(220,64,128,0.1); }`}</style>
    </div>
  );
}
