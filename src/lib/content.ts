...
// "https://pub-abc123.r2.dev" or "https://media.pinkhousekohsamui.com".
...
export const IMAGE_SLOTS: ReadonlyArray<{
  ...
  { slot: "rooms.cosy.cover", label: "Cosy room — photo 1 (cover)", fallback: "/images/room.jpeg" },
  { slot: "rooms.cosy.1", label: "Cosy room — photo 2", fallback: "/images/room.jpeg" },
  { slot: "rooms.cosy.2", label: "Cosy room — photo 3", fallback: "/images/room.jpeg" },
  {
    slot: "rooms.deluxe.cover",
    label: "Deluxe room — photo 1 (cover)",
    fallback: "/images/room.jpeg",
  },
  { slot: "rooms.deluxe.1", label: "Deluxe room — photo 2", fallback: "/images/room.jpeg" },
  { slot: "rooms.deluxe.2", label: "Deluxe room — photo 3", fallback: "/images/room.jpeg" },
  {
    slot: "rooms.family.cover",
    label: "Family room — photo 1 (cover)",
    fallback: "/images/room.jpeg",
  },
  { slot: "rooms.family.1", label: "Family room — photo 2", fallback: "/images/room.jpeg" },
  { slot: "rooms.family.2", label: "Family room — photo 3", fallback: "/images/room.jpeg" },
